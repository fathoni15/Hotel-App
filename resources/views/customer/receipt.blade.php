...
<hr><width="100" height="75">
    ...
    <center><b style="font-family: 'Courier New', Courier, monospace; font-size: 50px;">HOTEL <span style="color: gold">HEBAT</span></b></center><br>
...
<table width='100%' cellspacing='0' cellpadding='0'>
    <tr>
        <td valign='top' width='35%' style='font-size:12px;'>Client Name : {{ $receipt->user->name }}<br/><br/></td>
        <td valign='top' width='35%'></td>
        <td valign='top' width='30%' style='font-size:12px;'>Transaction ID : {{$receipt->id}}<br/></td>
    </tr>
</table>
...
<table width='100%' cellspacing='0' cellpadding='2' border='1' bordercolor='#CCCCCC'>
    <tr>
        ...
        <td bordercolor='#ccc' bgcolor='#f2f2f2' style='font-size:12px;'><strong>Room Number </strong></td>
    ...
    <tr style="display:none;">
        <td colspan="*">
            <tr>
                <td valign='top' style='font-size:12px;'>{{$receipt->kamar->tipe->name}}</td>
                <td valign='top' style='font-size:12px;'>{{$receipt->kamar->no_kamar}}</td>
                <td valign='top' style='font-size:12px;'>@currency($receipt->kamar->tipe->harga)</td>
                <td valign='top' style='font-size:12px;'>{{ $receipt->check_in }}</td>
                <td valign='top' style='font-size:12px;'>{{ $receipt->check_out }}</td>
                <td valign='top' style='font-size:12px;'>{{$receipt->jumlah_kamar}}</td>
            </tr>
            <tr>
...
<table width='100%' cellspacing='0' cellpadding='2' border='0'>
    <tr>
        ...
        <td  align='right' style='font-size:12px;'><b>@currency($receipt->pay->harga)</b></td>
    </tr>
</table>
...
<table  width='100%' cellspacing='0' cellpadding='2'>
    <tr>
        <td width='33%' style='border-top:double medium #CCCCCC;font-size:12px;' valign='top' ><b>HOTEL<span style="color: gold"> HEBAT</span></b><br/>Jl. Otto Iskandardinata, Kabupaten Garut, Jawa Barat<br/>Phone: +62-896-3070-6721<br/></td>
